...
const NewClientModal = ({ isOpenNewClientModal }) => {
    ...
    return (
        <div className="lg:p-10 md:p-10 sm:p-5 overflow-y-auto h-full">
            ...
            <div className="block -fit float-right pl-5">
                <button
                    onClick={() => isOpenNewClientModal(false)}
            ...
            <div className=" lg:w-2/3 md:w-5/6 mx-auto">
                <form action="">
                    ...
                    <div className="grid lg:grid-cols-2 lg:gap-5">
                        ...
                        <div>
                            <label htmlFor="org-name" className="block w-full text-[#9631FB] text-left text-2xl mb-3">
                                COMPANY NAME*
                            </label>
