        ...
        <div className=" w-full pt-10 pb-20 ">
            ...
            <div className="mb-10 grid grid-cols-3 pr-5">
                ...
                <div className=" col-span-1 h-fit my-auto w-fit mx-auto">
                    <button className=" px-3 py-2 border-2 border-[#9631FB] text-[#9631FB] rounded-full hover:bg-[#9631FB] hover:text-white duration-300">CREATE NEW PROJECT</button>
                </div>
            ...
            <div className="mb-20">
                <div className="lg:w-1/3 md:w-1/2 sm:w-5/6 mx-auto grid grid-cols-4 bg-gray-50 py-2 px-3 rounded-full drop-shadow-xl">
                    ...
                    <div className="col-span-3">
                        <input type="text" className="px-3 bg-gray-50 w-full border-0  border-r-gray-300 border-r-2 focus:border-transparent focus:border-r-gray-300 focus:ring-0 "/>
                    </div>
                    ...
                    <div className=" col-span-1">
                        <button className="  px-3 py-1"><img src="https://img.icons8.com/ios-glyphs/30/9631FB/search--v1.png" alt="search-icon"/></button>
                    </div>
