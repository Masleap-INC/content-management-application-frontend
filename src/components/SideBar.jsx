    ...
    <div>
      ...
      <div
        className={
          ...
          (state ? "md:translate-x-0 sm:block sm:translate-x-0 lg:w-1/5 md:w-64 sm:w-64 lg:fixed md:fixed sm:fixed duration-300 h-full overflow-y-auto" : "md:-translate-x-full sm:block sm:-translate-x-full lg:w-1/5 md:w-64 sm:w-64 lg:fixed md:fixed sm:fixed duration-300 h-full overflow-y-auto")
        }
      >
        <div className="w-5/6 mx-auto">
          <div className="block pt-5 mb-20 w-full">
            ...
            <div className="lg:hidden md:block sm:block  w-fit float-right">
              <button onClick={() => toggle()}>
                <img
                  src="https://img.icons8.com/ios/50/ffffff/close-window.png"
          ...
          <div className="mt-10">
            ...
            <div className="mt-10 pt-5 border-t-2 border-white text-2xl">
              <button className="pb-2 mb-5 hover:border-2 px-3 py-2 duration-100">
                LOGOUT
              </button>
            </div>
          </div>
        ...
        <div className="w-full py-3 px-5">
          ...
          <div className="inline-block w-fit mr-5 float-right" >
            <button onClick={() => toggle()} className={(state ? "rotate-90 duration-300" : " -rotate-90 duration-300")}>
              <img
                src="https://img.icons8.com/ios-glyphs/64/ffffff/circled-menu.png"
                alt="menu-button"
