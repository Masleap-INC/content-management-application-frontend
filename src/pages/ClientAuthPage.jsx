    ...
    <div>
      ...
      <div className="bg-gradient-to-br from-[#9631FB] to-[#319AFB] pt-10 pb-20 min-h-screen ">
        ...
        <div className="lg:grid lg:grid-cols-2 w-5/6 mx-auto h-full ">
            ...
            <div className="h-full my-auto overflow-x-hidden overflow-y-hidden lg:mt-10">

                {/* Heading */}

                <div className="mb-14 ">

                    <h2 className="text-5xl text-white text-left font-semibold lg:w-1/2 lg:pb-20 md:pb-20 sm:pb-20">LOGIN / SIGN UP TO GET ACCESS TO YOUR ACCOUNT !</h2>
            ...
            <div className=" overflow-x-hidden overflow-y-hidden h-full drop-shadow-2xl">
                ...
                <div className="">
                  ...
                  <div className={"w-full " + (hasAccount ? " translate-x-0 duration-500" : " translate-x-[1000px] duration-500 w-fit h-0")}>
                      <ClientLogin />
                  </div>

                  <div className={"w-full" + (hasAccount ? " translate-x-[1000px] duration-500 h-0" : " -translate-x-0 duration-500")}>
                      <ClientRegister />
                  </div>
